...
const Login = () => {
  ...
  const handleRegister = async (event) => {
    ...
    try {
      const response = await axios.post('https://pepper-paradise-9iol.onrender.com/api/register', {
        emailId,
        fullName,
        phoneNumber,
        password,
  ...
  const handleLoginSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('https://pepper-paradise-9iol.onrender.com/api/login', { emailId, password });
